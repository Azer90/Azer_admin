...
<div class="full m0a">
    ...
    <div tabshowbindfilter="ziyuan" class="oh">
        ...
        <div class="layui-row layui-col-space20 layui-hide white">
            <div onclick="openVideoBox('uploads/images/betty2/035.jpg','http://player.youku.com/player.php/sid/XMzQ4Mjc1MjM3Ng==/v.swf','照片展示小清新女生写真', '150295811828632', '视频资源', 'vsp', '159.74M','http://www.huishenghuiying.com.cn/zhuanxiang.html','49元');" class="layui-col-xs4">
                <div nohoverhide="true" hovershow="true" class="pr"><img class="maxw100" src="picture/035.jpg" alt="清新写真" />
                    <div class="pa w100p l0 b0 pl20 zi2">
                        <h3 class="fs30">照片展示</h3>
                        <p class="fs18 pt8 pb15">小清新女生写真</p>
                    </div>
                    <img src="picture/play.png" class="w39 pa zi2 r30 b25" />
                    <div class="indexShipinTitleBG"></div>
                </div>
            </div>
            <div onclick="openVideoBox('uploads/images/huishenghuiying/index4-18.jpg','//v.qq.com/iframe/player.html?vid=b03477tf470','中国风主题婚礼开场片头', '150295850028633', '视频资源', 'vsp', '68.37M', 'http://www.huishenghuiying.com.cn/zhuanxiang.html','30元');" class="layui-col-xs4">
                <div nohoverhide="true" hovershow="true" class="pr"><img class="maxw100" src="picture/index4-18.jpg" alt="中国风主题" />
                    <div class="pa w100p l0 b0 pl20 zi2">
                        <h3 class="fs30">中国风主题婚礼</h3>
                        <p class="fs18 pt8 pb15">中国风是一种气质、一种文化、一种情节</p>
                    </div>
                    <img src="picture/play.png" class="w39 pa zi2 r30 b25" />
                    <div class="indexShipinTitleBG"></div>
                </div>
            </div>
            <div onclick="openVideoBox('uploads/images/huishenghuiying/index4-19.jpg','//player.youku.com/embed/XMTU1ODA5NTIyMA','时尚动感油性笔刷字母', '150552455228899', '视频资源', 'vsp', '53.07M', 'http://www.huishenghuiying.com.cn/zhuanxiang.html','20元');" class="layui-col-xs4">
                <div nohoverhide="true" hovershow="true" class="pr"><img class="maxw100" src="picture/index4-19.jpg" alt="文字动画" />
                    <div class="pa w100p l0 b0 pl20 zi2">
                        <h3 class="fs30">时尚字母书写</h3>
                        <p class="fs18 pt8 pb15">欢快明亮的文字动画</p>
                    </div>
                    <img src="picture/play.png" class="w39 pa zi2 r30 b25" />
                    <div class="indexShipinTitleBG"></div>
                </div>
            </div>
            <div onclick="openVideoBox('uploads/images/betty2/0636.jpg','http://xiazai.huishenghuiying.com.cn/bofang/zbmuban/DDPT060.mp4','年终盛典', '150302753628638', '视频资源', 'vsp', '107.98M', 'http://www.huishenghuiying.com.cn/nzsd.html','49元');" class="layui-col-xs4">
                <div nohoverhide="true" hovershow="true" class="pr"><img class="maxw100" src="picture/0636.jpg" alt="年终盛典" />
                    <div class="pa w100p l0 b0 pl20 zi2">
                        <h3 class="fs30">年终盛典</h3>
                        <p class="fs18 pt8 pb15">砥砺前行，感谢有你</p>
                    </div>
                    <img src="picture/play.png" class="w39 pa zi2 r30 b25" />
                    <div class="indexShipinTitleBG"></div>
                </div>
            </div>
            <div onclick="openVideoBox('uploads/images/huishenghuiying/index4-21.jpg','//player.youku.com/embed/XMzUzMTMwNDMxMg','儿童写真电子相册','152358298831099','视频资源', 'vsp', '28.61M', 'http://www.mairuan.cn/detail-31099.html','15元');" class="layui-col-xs4">
                <div nohoverhide="true" hovershow="true" class="pr"><img class="maxw100" src="picture/index4-21.jpg" alt="儿童相册" />
                    <div class="pa w100p l0 b0 pl20 zi2">
                        <h3 class="fs30">儿童写真电子相册</h3>
                        <p class="fs18 pt8 pb15">每个孩子都是一本既难度又易读的书</p>
                    </div>
                    <img src="picture/play.png" class="w39 pa zi2 r30 b25" />
                    <div class="indexShipinTitleBG"></div>
                </div>
            </div>
            <div onclick="openVideoBox('uploads/images/betty2/089.jpg','//player.youku.com/embed/XMjgyMDAyNjY0OA','电影宣传片', '14974175194203', '视频资源', 'vsp', '36.38M', 'http://www.huishenghuiying.com.cn/zhuanxiang.html','39元');" class="layui-col-xs4">
                <div nohoverhide="true" hovershow="true" class="pr"><img class="maxw100" src="picture/089.jpg" alt="电影宣传" />
                    <div class="pa w100p l0 b0 pl20 zi2">
                        <h3 class="fs30">电影宣传片</h3>
                        <p class="fs18 pt8 pb15">快速切换效果让你目不暇接</p>
                    </div>
                    <img src="picture/play.png" class="w39 pa zi2 r30 b25" />
                    <div class="indexShipinTitleBG"></div>
                </div>
        ...
        <div class="layui-row layui-col-space20 layui-hide">
            <div class="layui-col-xs4">
                <div nohoverhide="true" hovershow="true" class="pr"><a target="_blank" class="white chwhite" href="video/nzsdbj-jc.html"> <img class="maxw100" src="picture/nzbjjt.jpg" alt="年终盛典颁奖" />
                        <div class="pa w100p l0 b0 pl20 zi2">
                            <h3 class="fs30">年会颁奖预告片头</h3>
                            <p class="fs18 pt8 pb15">公司年会必备</p>
                        </div>
                        <img src="picture/play.png" class="w39 pa zi2 r30 b25" />
                        <div class="indexShipinTitleBG"></div>
                    </a></div>
            ...
            <div class="layui-col-xs4">
                <div nohoverhide="true" hovershow="true" class="pr"><a target="_blank" class="white chwhite" href="video/ins-boke.html"> <img class="maxw100" src="picture/ins-boke.jpg" alt="ins博客" />
                        <div class="pa w100p l0 b0 pl20 zi2">
                            <h3 class="fs30">仿AE Ins风电子相册制作</h3>
                            <p class="fs18 pt8 pb15">时尚简洁唯美</p>
                        </div>
                        <img src="picture/play.png" class="w39 pa zi2 r30 b25" />
                        <div class="indexShipinTitleBG"></div>
                    </a></div>
            ...
            <div class="layui-col-xs4">
                <div nohoverhide="true" hovershow="true" class="pr"><a target="_blank" class="white chwhite" href="video/gufeng-taohua.html"> <img class="maxw100" src="picture/gufeng-taohua.jpg" alt="长安忆创意古风" />
                        <div class="pa w100p l0 b0 pl20 zi2">
                            <h3 class="fs30">长安忆创意古风</h3>
                            <p class="fs18 pt8 pb15">惟有此曲能寄心中意</p>
                        </div>
                        <img src="picture/play.png" class="w39 pa zi2 r30 b25" />
                        <div class="indexShipinTitleBG"></div>
                    </a></div>
            ...
            <div class="layui-col-xs4">
                <div nohoverhide="true" hovershow="true" class="pr"><a target="_blank" class="white chwhite" href="video/blhdxz-jc.html"> <img class="maxw100" src="picture/index4-26.png" alt="毕业" />
                        <div class="pa w100p l0 b0 pl20 zi2">
                            <h3 class="fs30">彩色玻璃相册</h3>
                            <p class="fs18 pt8 pb15">炫彩玻璃滑动</p>
                        </div>
                        <img src="picture/play.png" class="w39 pa zi2 r30 b25" />
                        <div class="indexShipinTitleBG"></div>
                    </a></div>
            ...
            <div class="layui-col-xs4">
                <div nohoverhide="true" hovershow="true" class="pr"><a target="_blank" class="white chwhite" href="video/qrjbbpt-jc.html"> <img class="maxw100" src="picture/index4-27.jpg" alt="情人节表白" />
                        <div class="pa w100p l0 b0 pl20 zi2">
                            <h3 class="fs30">情人节表白必备</h3>
                            <p class="fs18 pt8 pb15">文字表白片头</p>
                        </div>
                        <img src="picture/play.png" class="w39 pa zi2 r30 b25" />
                        <div class="indexShipinTitleBG"></div>
                    </a></div>
            ...
            <div class="layui-col-xs4">
                <div nohoverhide="true" hovershow="true" class="pr"><a target="_blank" class="white chwhite" href="video/jjswxc-jc.html"> <img class="maxw100" src="picture/index4-28.jpg" alt="商务相册" />
                        <div class="pa w100p l0 b0 pl20 zi2">
                            <h3 class="fs30">企业商务</h3>
                            <p class="fs18 pt8 pb15">简洁明亮的商务宣传相册</p>
                        </div>
                        <img src="picture/play.png" class="w39 pa zi2 r30 b25" />
                        <div class="indexShipinTitleBG"></div>
                    </a></div>
