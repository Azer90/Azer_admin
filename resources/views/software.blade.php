...
<div tabshowbindfilter="x2018Content">
    <div class="x2018Content1">
        ...
        <div class="all m0a pr">
            ...
            <img width="790px" height="422px" src="{{asset('picture/1.png')}}" class="pa r0 t0" /></div>


        <div class="all m50a">
            <h2 class="fs36 tac pb20">{{ $config['title'] }}功能简介</h2>
            <div class="layui-row pt30 pb30">
                <div class="layui-col-xs6 pr30"><img width="560px" height="306px" src="{{asset('picture/1.png')}}" alt="PDF转换其他文件" />
                ...
                <div class="layui-col-xs6 pl30"><img width="560px" height="306px"  src="{{asset('picture/2.png')}}" alt="其他文件转换成PDF" />
                    <h3 class="xinTitle pt20 pb10 fs22">其他文件转换成PDF</h3>
                    <p class="fs16 c6 ">其他文件转换成PDF支持：图片转PDF、Word转PDF、PPT转PDF、Excel转PDF，支持多种方法</p>
                </div>
            </div>
            <div class="layui-row pt30 pb30">
                <div class="layui-col-xs6 pr30"><img width="560px" height="306px"  src="{{asset('picture/3.png')}}" alt="PDF的其他操作" />
                    <h3 class="xinTitle pt20 pb10 fs22">PDF的其他操作</h3>
                    <p class="fs16 c6 ">PDF的其他操作支持：PDF分割、PDF合并、PDF压缩、PDF解除密码、PDF图片获取。</p>
                </div>
                <div class="layui-col-xs6 pl30"><img width="560px" height="306px"  src="{{asset('picture/4.png')}}" alt="电子书格式转换" />
