...
<link rel="stylesheet" type="text/css" href="css/home/style_sur.css">
<body>
@include('layouts.nav')
...
<article class="wrapper full">
    <ul class="the-category-list the-category-list-help">
        <li class="the-category-name the-category-help">
            <a href="http://www.xjpdf.com/help">
        ...
        <li class="category-list-help">
            <div class="item-wrap">
                <h1 class="title"><a href="http://www.xjpdf.com/1323.html" title="PPT幻灯片文档转换成Word文档怎么转" rel="bookmark">PPT幻灯片文档转换成Word文档怎么转</a></h1>
                <div class="excerpt">PPT幻灯片文档和Word文档都是常用的文档格式，如果我们在使用PPT幻灯片文档时，想要将PPT转换成Word文档，那么应该怎...</div>
                <p class="more">
                    <a href="http://www.xjpdf.com/1323.html" title="PPT幻灯片文档转换成Word文档怎么转" rel="bookmark">更多>></a>
                </p>
            </div>
        </li>
        <li class="category-list-help">
            <div class="item-wrap">
                <h1 class="title"><a href="http://www.xjpdf.com/1368.html" title="用电脑如何将电子书MOBI转TXT" rel="bookmark">用电脑如何将电子书MOBI转TXT</a></h1>
                <div class="excerpt">网上其实有不少的电子书格式是MOBU格式的，如果想要将下载的MOBI电子书转换成TXT应该怎么进行转换？用电脑如何将电子书MO...</div>
                <p class="more">
                    <a href="http://www.xjpdf.com/1368.html" title="用电脑如何将电子书MOBI转TXT" rel="bookmark">更多>></a>
                </p>
            </div>
        </li>
        <li class="category-list-help">
            <div class="item-wrap">
                <h1 class="title"><a href="http://www.xjpdf.com/1375.html" title="电脑上将PPT转换成PDF格式的两种方法" rel="bookmark">电脑上将PPT转换成PDF格式的两种方法</a></h1>
                <div class="excerpt">PPT格式文件是在会议当中经常会使用的文件格式，如果我们想要将PPT转换成PDF格式那么应该怎么进行转换，电脑上如何将PPT转...</div>
                <p class="more">
                    <a href="http://www.xjpdf.com/1375.html" title="电脑上将PPT转换成PDF格式的两种方法" rel="bookmark">更多>></a>
                </p>
            </div>
        </li>
    </ul>
    ...
    <ul class="the-category-list the-category-list-problems">
        <li class="the-category-name the-category-prblems">
            <a href="http://www.xjpdf.com/problems">
        ...
        <li>
            <div class="category-list-problems">
                <div class="item-wrap">
                    <dl>
                        <dd class="item-title"><h1><i>1</i><span> question</span></h1></dd>
                        <dd class="item-excerpt">
                            <div title="迅捷PDF转换器能为我做什么？" rel="bookmark">
                                <h2><a href="http://www.xjpdf.com/128.html" title="迅捷PDF转换器能为我做什么？" rel="bookmark">迅捷PDF转换器能为我做什么？</a></h2>
                                <div class="excerpt">答：迅捷PDF转换器可以实现多种办公文档格式的转换，包括将PDF转换成Word、PPT、Excel、HTML、TXT、图片；将...</div>
                                <a class="more" href="http://www.xjpdf.com/128.html" title="迅捷PDF转换器能为我做什么？" rel="bookmark">更多>></a>
                            </div>
                        </dd>
                    </dl>
                </div>
                <div class="item-wrap">
                    <dl>
                        <dd class="item-title"><h1><i>2</i><span> question</span></h1></dd>
                        <dd class="item-excerpt">
                            <div title="注册账号丢失了如何找回？" rel="bookmark">
                                <h2><a href="http://www.xjpdf.com/126.html" title="注册账号丢失了如何找回？" rel="bookmark">注册账号丢失了如何找回？</a></h2>
                                <div class="excerpt">答：用户若是需要找回之前购买软件的账号及密码，只需在登录页面选择忘记密码，就可以找回。或联系在线客服帮忙找回。...</div>
                                <a class="more" href="http://www.xjpdf.com/126.html" title="注册账号丢失了如何找回？" rel="bookmark">更多>></a>
                            </div>
                        </dd>
                    </dl>
                </div>
                <div class="item-wrap">
                    <dl>
                        <dd class="item-title"><h1><i>3</i><span> question</span></h1></dd>
                        <dd class="item-excerpt">
                            <div title="注册后使用有时间限制吗？" rel="bookmark">
                                <h2><a href="http://www.xjpdf.com/124.html" title="注册后使用有时间限制吗？" rel="bookmark">注册后使用有时间限制吗？</a></h2>
                                <div class="excerpt">答：迅捷PDF转换器采取会员制，用户在注册购买时可自主选择套餐，套餐不同，可使用的时间也不同。...</div>
                                <a class="more" href="http://www.xjpdf.com/124.html" title="注册后使用有时间限制吗？" rel="bookmark">更多>></a>
                            </div>
                        </dd>
                    </dl>
                </div>
                <div class="item-wrap">
                    <dl>
                        <dd class="item-title"><h1><i>4</i><span> question</span></h1></dd>
                        <dd class="item-excerpt">
                            <div title="试用版软件和注册版软件有何不同？" rel="bookmark">
                                <h2><a href="http://www.xjpdf.com/122.html" title="试用版软件和注册版软件有何不同？" rel="bookmark">试用版软件和注册版软件有何不同？</a></h2>
                                <div class="excerpt">答：迅捷PDF转化器试用版软件，只提供文档前五页的转换，而注册版软件可以使用软件的全部功能，同时支持批量转换。...</div>
                                <a class="more" href="http://www.xjpdf.com/122.html" title="试用版软件和注册版软件有何不同？" rel="bookmark">更多>></a>
                            </div>
                        </dd>
                    </dl>
                </div>
